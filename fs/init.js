...
let breath = Timer.set(200, Timer.REPEAT, breathe, null);
...
let setAlert = function(alert) {
  ...
  if (state.alert === "test") {
    ...
    ring = Timer.set(1000, Timer.REPEAT, clockwise, null);
  } else if (state.alert === "ring_ccw") {
    ring = Timer.set(1000, Timer.REPEAT, counterclockwise, null);
  } else {
